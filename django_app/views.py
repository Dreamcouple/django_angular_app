    ...
    def post(self, request):
        try:
            ...
            if User.objects.filter(email=email).exists():
                ...
                return Response({'error': 'user details is  not found'}, status=status.HTTP_200_OK)
...
class PasswordTokenCheckAPI(generics.GenericAPIView):
    ...
    def get(self, request, uidb64, token):
        ...
        try:
            ...
            return Response({'success': 'true','message': 'Token is valid', 'uidb64': uidb64, 'token':token},
